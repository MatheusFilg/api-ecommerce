...
application.config['SECRET_KEY'] = "minhachave123"
...
def update_product(product_id):
    product = Product.query.get(product_id)
    if not product:
        return jsonify({"message": "Product not foud"}),404
...
def view_cart():
    ...
    #O ideal é buscar todos os produtos de uma só vez ao invés de 
    #ir e voltar ao banco trazendo um produto por vez
